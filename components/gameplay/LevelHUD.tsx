  ...
  return (
    <div className="fixed top-4 right-4 sm:top-8 sm:right-8 z-[500] flex flex-col items-end gap-2 pointer-events-none select-none">
      ...
      <div className="flex items-center shadow-2xl">
        ...
        <button
          onClick={exitCourse}
          className="hidden sm:flex pointer-events-auto mr-2 items-center justify-center gap-2 h-12 sm:h-16 w-20 sm:w-24 rounded-xl sm:rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 text-white/50 hover:text-white hover:border-white/30 transition-all active:scale-95 flex-col shadow-lg"
        >
        ...
        {/* Level Card */}
        <div className="relative -mr-4 h-12 sm:h-16 min-w-[110px] sm:min-w-[160px] pl-4 sm:pl-10 pr-6 sm:pr-10 flex flex-col justify-center bg-black/60 backdrop-blur-xl border-y border-l border-white/10 rounded-l-2xl">
        ...
        {/* Letter Square */}
        <div className="relative z-10 w-16 h-16 sm:w-24 sm:h-24 rounded-xl sm:rounded-2xl rainbow-border animate-rotate-gradient p-0.5 flex items-center justify-center bg-black/80 shadow-black/40 overflow-hidden shrink-0">
          <div className="w-full h-full rounded-xl sm:rounded-2xl bg-[#0d0d0d] flex items-center justify-center border border-white/5 overflow-hidden">
      ...
      <button
        onClick={exitCourse}
        className="sm:hidden pointer-events-auto flex items-center justify-center gap-1.5 w-16 h-7 rounded-xl bg-black/60 backdrop-blur-md border border-white/10 text-white/50 hover:text-white hover:border-white/30 transition-all active:scale-95 shadow-lg"
      >
